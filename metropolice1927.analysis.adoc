...
:head8: von heute an wünsche ich, über jeden Schritt meines Sohnes genau unterrichtet zu werden ...
== {head8}
...
:head10:
Ich habe ein einziges Mal im Leben etwas vergessen: Dass Hel ein Weib war und \
Du ein mann
== {head10}
...
{head15} Ich möcht doch herausbekommen, was meine Arbeiter in den Katakomben zu\ 
 tun haben
== {head15}
