...
:mean4: i wanted to look into the faces of the people, whose small children are my brothers and sisters.
=== :{mean4}
...
=== :do you think the loss of a hand is too high of a price for the recreation of 
Hel?
...
== Kannst Du mir dise Pläne enträtseln, die man seit Monaten in den Taschen meiner Arbeiter findet ? 
